...
.shop-order-form .payment-calc-box {position:relative;float:left;width:50%;text-align:center;padding:20px 0;font-size:13px;color:#757575}
...
@media (max-width:991px) {
    .shop-order-form .order-table th {width:70px !important;text-align:left;padding:5px 0;}
...
<div class="shop-order-form">
    ...
    <div class="order-member-area">
                ...
                <table>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <label for="od_hp" class="hidden-lg hidden-md">휴대전화번호</label>
                                <label class="input width-200px required-mark">
        ...
        <div class="sod-frm-taker">
            <div class="headline-short"><h4><strong>유의사항</strong></h4></div>
            <div class="order-table">
                <table>
                    <tbody>
                        <tr>
...
function pay_approval()
{
    ...
    if( jQuery(pf).triggerHandler("form_sumbit_order_"+form_order_method) !== false ) {
        ...
        <?php if($default['de_pg_service'] == 'danalpay') { // wetoz : danalpay - mobile ?>

        switch(settle_method)
        {
            case "계좌이체":
                f.paymethod.value = "dbank";
                f.action = g5_url+"/shop/danalpay/dbank/Ready.php";
                break;
            case "가상계좌":
                f.paymethod.value = "vbank";
                f.action = g5_url+"/shop/danalpay/vbank/Ready.php";
                break;
            case "휴대폰":
                f.paymethod.value = "cellphone";
                f.action = g5_url+"/shop/danalpay/cellphone/Ready.php";
                break;
            case "신용카드":
                f.paymethod.value = "card";
                f.action = g5_url+"/shop/danalpay/card/Ready.php";
                break;
            default:
...
function orderfield_check(f)
{
    ...
    check_field(f.od_hp, "주문하시는 분 휴대전화번호를 입력하십시오.");
...
<script>
    ...
    IMP.init("imp73320837"); // 예: imp00000000
    ...
    function requestPay() {
      ...
      IMP.request_pay({ // param
          ...
          name: "[test]",
          amount: "<?php echo number_format($tot_price); ?>",
