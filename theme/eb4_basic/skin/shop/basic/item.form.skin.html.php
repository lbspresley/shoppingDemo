        ...
        <div class="col-sm-6 sm-margin-bottom-30">
            ...
            <div class="shop-product-img">
                <div class="product-img-big">
                    <?php foreach ($big_img as $k => $bimg) { echo $bimg[1];?>
                ...
                <!-- <?php if ($thumb_total_count > 0) { ?>
                <div class="product-thumb">
                    <?php foreach ($thumb_info as $k => $timg) { echo $timg."<br>";?>
                    <div class="thumb-img">
                        <?php echo $timg['image']; ?> <?php echo $k."-".$timg['cnt']; ?><span class="sound_only"><?php echo $timg['cnt']; ?>번째 이미지 새창</span>
                    </div>
                    <?php } ?>
                </div>
                <?php } ?> -->
            ...
            <div class="shop-product-prev-next">
                ...
                <a href="<?php echo $prev_href; ?>" class="product-prev">
                    <i class="fas fa-chevron-left" aria-hidden="true"></i> 이전작품 <span class="sound_only"> <?php echo $prev_title; ?></span>
                </a>
                <a href="<?php echo $next_href; ?>" class="product-next">
                    다음작품 <span class="sound_only"> <?php echo $next_title; ?></span> <i class="fas fa-chevron-right" aria-hidden="true"></i>
                </a>
                <?php } else { ?>
                <span class="sound_only">이 분류에 등록된 다른 작품이 없습니다.</span>
                <?php } ?>
                    ...
                    <ul id="sit_opt_added">
                        <li class="sit_opt_list">
                            ...
                            <div class="opt_count">
                                ...
                                <input type="text" name="ct_qty[<?php echo $it_id; ?>][]" value="<?php echo $it['it_buy_min_qty']; ?>" id="ct_qty_<?php echo $i; ?>" class="num_input" size="5" readonly>
