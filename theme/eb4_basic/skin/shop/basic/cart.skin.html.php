...
.shop-cart .shop-cart-total .cart-total-box {position:relative;float:left;width:50%;height:94px;text-align:center;padding:20px 0;font-size:14px;box-sizing:border-box}
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-right td-border"><?php echo number_format($list[$i]['point']); ?></td>
