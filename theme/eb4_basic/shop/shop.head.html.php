    ...
    <?php } ?>
        ...
        <div class="header-nav header-sticky">
            <div class="navbar" role="navigation">
                <div class="container">
                    <?php /* ---------- 공지사항 시작 // 991픽셀 이하에서만 출력 // 모바일 공지사항 ---------- */ ?>
                    <div class="nav-center hidden-md hidden-lg">
<!-- 
					<div style="width:100%;text-align:center">"Real Art, No Doubt. RealCollection."</div>
-->
					<div style="width:100%;text-align:center">"Welcome Audition-Me with your K-POP life!"</div>
...
<!--
								<li class="nav-mo-half"><a href="#">Real Art, No Doubt. RealCollection.</a></li>
-->
								<li class="nav-mo-half"><a href="#">Welcome Audition-Me with your K-POP life!</a></li>
