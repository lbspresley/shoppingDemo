            ...
            <div class="tbl_frm01">
                        ...
                        if ($od['od_settle_case'] != '무통장') {
                            switch($od['od_pg']) {
                                ...
                                case 'KAKAOPAY':
                                    ...
                                    $pg_test = 'KAKAOPAY';
                                    break;
                                case 'danalpay': // wetoz : danalpay
                                    $pg_url  = 'https://cp.teledit.com/login/';
                                    $pg_test = '다날페이';
                                    break;
                                default:
                ...
                <tr>
                    ...
                    if ($od['od_cash']) {
                        ...
                        } else if($od['od_pg'] == 'danalpay') { // wetoz : danalpay
                            $cash_receipt_script = '';
                        } else {
...
function form_submit(f)
{
    ...
    // wetoz || ($od['od_pg'] == 'danalpay' && ($od['od_settle_case'] == '휴대폰' || $od['od_settle_case'] == '계좌이체')) 추가
    <?php if($od['od_settle_case'] == '신용카드' || $od['od_settle_case'] == 'KAKAOPAY' || $od['od_settle_case'] == '간편결제' || ($od['od_pg'] == 'inicis' && is_inicis_order_pay($od['od_settle_case']) ) || ($od['od_pg'] == 'danalpay' && ($od['od_settle_case'] == '휴대폰' || $od['od_settle_case'] == '계좌이체'))) { ?>
