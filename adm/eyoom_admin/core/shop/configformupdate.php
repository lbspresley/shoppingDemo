...
if ($_POST['amode'] == 'ittype') {
    ...
    // wetoz : danalpay
    $sql = " update {$g5['g5_shop_default_table']}
                set de_danalpay_cpid            = '{$_POST['de_danalpay_cpid']}',
                    de_danalpay_cryptokey       = '{$_POST['de_danalpay_cryptokey']}',
                    de_danalpay_itemcode        = '{$_POST['de_danalpay_itemcode']}',
                    de_danalpay_ispreotbill     = '{$_POST['de_danalpay_ispreotbill']}',
                    de_danalpay_hp_cpid         = '{$_POST['de_danalpay_hp_cpid']}',
                    de_danalpay_hp_cryptokey    = '{$_POST['de_danalpay_hp_cryptokey']}',
                    de_danalpay_dbank_cpid      = '{$_POST['de_danalpay_dbank_cpid']}',
                    de_danalpay_dbank_cryptokey = '{$_POST['de_danalpay_dbank_cryptokey']}',
                    de_danalpay_vbank_cpid      = '{$_POST['de_danalpay_vbank_cpid']}',
                    de_danalpay_vbank_cryptokey = '{$_POST['de_danalpay_vbank_cryptokey']}'
                    ";
    sql_query($sql);
