<?php
	...
	******************************************************/
	$DN_CREDIT_URL = "https://tx-wiretransfer.danalpay.com/bank/";
	...
	******************************************************/
	$CPID = $g_conf_dbank_site_cd; //실서비스를 위해서는 반드시 교체필요. 영업담당자에게 문의
	$CRYPTOKEY = $g_conf_dbank_mer_key;// 암호화Key. 실서비스를 위해서는 반드시 교체필요. 영업담당자에게 문의
	$IVKEY = "31363032313523404542616e6b456e63"; // IV 고정값.
	...
	******************************************************/
	function CallDanalBank( $REQ_DATA, $Debug ){		
		global $CPID;
	 ...
	 *******************************************************/
	function CallDanalBankExec( $REQ_DATA, $Debug ){
