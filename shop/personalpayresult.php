                ...
                <tr>
                    ...
                    <td>
                        ...
                        if($pp['pp_settle_case'] == '휴대폰')
                        {
                            ...
                            } else if($pp['pp_pg'] == 'danalpay') { // wetoz : danalpay
                        ...
                        if($pp['pp_settle_case'] == '신용카드')
                        {
                            if($pp['pp_pg'] == 'lg') {
                                ...
                                $od_tno           = $pp['pp_tno'];
                                $od_id            = $pp['pp_id'];
                                $od_receipt_price = $pp['pp_receipt_price'];
                                $receipturl       = '';
                                require_once G5_SHOP_PATH.'/danalpay/card/receipt.php';

                                $card_receipt_script = 'window.open(\''.$receipturl.'\', \'popupIssue\', \'toolbar=no,location=no,directories=no,status=yes,menubar=no,scrollbars=yes, resizable=yes,width=420,height=540\');';
                            } else {
                ...
                <tr>
                    ...
                    if ($pp['pp_cash'])
                    {
                        if($pp['pp_pg'] == 'lg') {
                            ...
                            $cash_receipt_script = 'alert(\'현금 영수증이 발행되지 않습니다.\');';
                        } else {
