...
if ($pp_settle_case == "계좌이체")
{
    switch($default['de_pg_service']) {
        ...
        case 'danalpay': // wetoz : danalpay
			include G5_SHOP_PATH.'/danalpay/dbank/pay_result.php';
            break;
        default:
...
else if ($pp_settle_case == "가상계좌")
{
    switch($default['de_pg_service']) {
        ...
        case 'inicis':
            ...
            break;
        case 'danalpay': // wetoz : danalpay
			include G5_SHOP_PATH.'/danalpay/vbank/pay_result.php';
            break;
        default:
            include G5_SHOP_PATH.'/kcp/pp_ax_hub.php';
...
else if ($pp_settle_case == "휴대폰")
{
    switch($default['de_pg_service']) {
        ...
        case 'inicis':
            ...
            break;
        case 'danalpay': // wetoz : danalpay
			include G5_SHOP_PATH.'/danalpay/cellphone/pay_result.php';
            break;
        default:
            include G5_SHOP_PATH.'/kcp/pp_ax_hub.php';
            break;
...
else if ($pp_settle_case == "신용카드")
{
    switch($default['de_pg_service']) {
        ...
        case 'inicis':
            ...
            break;
        case 'danalpay': // wetoz : danalpay
			include G5_SHOP_PATH.'/danalpay/card/pay_result.php';
            break;
        default:
            include G5_SHOP_PATH.'/kcp/pp_ax_hub.php';
